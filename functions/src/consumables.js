...
const potions = [{
    ...
    "text": "A healing potion is a vial of a ruby-red liquid that imparts a tingling sensation as the drinker\u2019s wounds heal rapidly. When you drink a healing potion, you regain the listed number of Hit Points.",
    ...
    "category": "potion",
    "level": " 4;  8; ",
    "price": " 15 gp 90 gpThis potion has no onset, lasts for 1 hour, and grants the effects of a 4th-level shrink spell. In addition, you gain a +2 item bonus to Stealth checks while shrunken.",
    "traits": ["Consumable", "Magical", "Potion", "Transmutation"],
    "text": "This fungus-flavored potion conveys the effects of the  shrink  spell to make you and all your gear smaller. After the onset, you remain small for 10 minutes. ",
    "source": "Core Rulebook pg. 564",
    "usage": " held in 1 hand",
    "actions": "Single Action",
    "activate": " Interact"
    ...
    "text": "Drinking this thick, fortifying potion grants resistance against a single damage type for 1 hour. Each   is created to defend against acid, cold, electricity, fire, or sonic damage (and is called a   or the like).",
    ...
    "price": "90 gpThis potion has no onset, lasts for 1 hour, and grants the effects of a 4th-levelshrinkspell. In addition, you gain a +2 item bonus to Stealth checks while shrunken.",
    "source": "Core Rulebook pg. 564",
    "level": 8,
    "traits": ["Consumable", "Magical", "Potion", "Transmutation"],
    "usage": "held in 1 hand",
    ...
    "category": "potion",
    "level": " 8;  15; ",
    "price": " 100 gp 1,000 gpThe fly Speed lasts for 1 hour.",
    "traits": ["Consumable", "Magical", "Potion", "Transmutation"],
